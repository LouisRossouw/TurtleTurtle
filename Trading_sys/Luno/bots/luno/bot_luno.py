...
# Bot Config info
    ...
    Risk_mode = config['LUNO_active_bots'][Bot_Name]['Risk_mode']
...
# # ################################ ADD CUSTOMISABLE ALGO SECTION
    ...
    if Risk_mode == 'buy':
        ...
        algo_data = ALGO.LOW_RISK_TRADING(
                                    Bot_Name,
                                    askPrice, 
                                    bidPrice, 
                                    collect_ask, 
