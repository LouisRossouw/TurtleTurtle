...
# txids = blockexplorer.get_transaction_ids(block_hash)   #### usefull
# print(txids)
...
txids = blockexplorer.get_transaction_ids(tip_hash)[-10:]   #### usefull
...
for i in txids:
    ...
    addr_info = blockexplorer.get_transaction(i)

 

    value = addr_info.vin[0]["prevout"]["value"] * float(0.00000001)
    timestamp = addr_info.status["block_time"]

    date = datetime.fromtimestamp(timestamp)


    print(date, ' - ', value, 'BTC')