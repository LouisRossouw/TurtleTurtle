...
import Valr.libs.utils.collect_historical_data as Collect
import Valr.libs.utils.toolUtils as ToolUtils
import Valr.libs.globals.Global_BackTest as GLOBAL
import pprint
...
def get_profits(all=True, input_bot=None, input="year"):
    ...
    config_path =  (os.getenv("Turtle") + "/Trading_sys/Valr") + '/config.yaml'
